...
//   static const String _keyCommitCount = 'commit_count';
//   static const String _keyResistCount = 'resist_count';
...
//   Future<void> incrementCommits() async {
//     final count = _prefs.getInt(_keyCommitCount) ?? 0;
//     await _prefs.setInt(_keyCommitCount, count + 1);
//   }

//   Future<void> incrementResists() async {
//     final count = _prefs.getInt(_keyResistCount) ?? 0;
//     await _prefs.setInt(_keyResistCount, count + 1);
//   }
...
//   int getCommitCount() => _prefs.getInt(_keyCommitCount) ?? 0;

//   int getResistCount() => _prefs.getInt(_keyResistCount) ?? 0;
